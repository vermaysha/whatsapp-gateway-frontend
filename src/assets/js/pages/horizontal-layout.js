...
function j(c, a, k, d) {
  ...
  window.requestAnimationFrame(function s(r) {
    ...
    var b = r - l
    d
      ? ((c.style.height = m * b + 'px'),
        (c.style.paddingTop = n * b + 'px'),
        (c.style.paddingBottom = o * b + 'px'),
        (c.style.marginTop = p * b + 'px'),
        (c.style.marginBottom = q * b + 'px'))
      : ((c.style.height = e - m * b + 'px'),
        (c.style.paddingTop = f - n * b + 'px'),
        (c.style.paddingBottom = g - o * b + 'px'),
        (c.style.marginTop = h - p * b + 'px'),
        (c.style.marginBottom = i - q * b + 'px')),
      b >= a
        ? ((c.style.height = ''),
          (c.style.paddingTop = ''),
